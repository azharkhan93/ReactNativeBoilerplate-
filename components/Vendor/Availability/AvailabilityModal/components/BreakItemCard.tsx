...
export const BreakItemCard: React.FC<BreakItemCardProps> = ({
  ...
  <View
    className={`${CARD_STYLE} flex-row items-center justify-between border border-gray-800 rounded-3xl p-5 mb-3 bg-gray-900/60`}
  >
    <View className="flex-1 mr-4">
      <Typography className="text-white font-body-bold text-sm">
        {breakItem.label}
      </Typography>
      <Typography className="text-gray-500 text-[12px] mt-0.5 font-body-semibold uppercase tracking-wider">
