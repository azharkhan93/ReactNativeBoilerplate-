      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View className="px-5 py-6 pb-12">
          <View className="flex-row justify-between items-center mb-6">
            <View>
              <Typography variant="h3" className="text-xl mb-1 text-slate-900">
                Your Services
              </Typography>
            ...
            >
              ...
              <Typography className="text-primary-500 font-body-semibold ml-2">
                Add New
              </Typography>
            </TouchableOpacity>
          </View>
          ...
          {services.length === 0 ? (
            <View className="bg-white border border-slate-200 rounded-3xl p-8 items-center justify-center mb-6">
              <Typography className="text-slate-400 text-center font-body mb-4">
                No services defined yet.
              </Typography>
              <Button variant="outlined" size="sm" onPress={handleOpenAddModal}>
            ...
            services.map((service, index) => {
              ...
              return (
                <View
                  ...
                  className="bg-white border border-slate-200 rounded-3xl p-5 mb-5"
                >
                  <View className="flex-row justify-between items-start mb-3">
                    ...
                    <View className="bg-green-500/10 px-3 py-1 rounded-full flex-row items-center border border-green-500/20">
                      ...
                      <Typography className="text-green-500 font-body-bold ml-1">
                        {service.price}
                      </Typography>
                    </View>
                  </View>
                  ...
                  <Typography
                    variant="body"
                    className="text-slate-500 mb-5 leading-5"
                  >
                    {service.description}
                  </Typography>

                  <View className="flex-row items-center justify-center mb-5 bg-notchLight py-4 px-4 rounded-2xl border border-slate-200 w-full overflow-hidden">
                    <View className="flex-row items-center flex-shrink mr-8">
                      ...
                      <Typography
                        variant="body"
                        className="text-slate-700 font-body-medium flex-shrink"
                        numberOfLines={1}
                      >
                        {service.duration}
                      </Typography>
