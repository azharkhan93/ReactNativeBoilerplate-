...
import { BusinessProfileData } from './hooks/useBusinessProfile';
...
export const BusinessProfileForm: React.FC<BusinessProfileFormProps> = ({
  ...
  const [formData, setFormData] = useState<BusinessProfileData>(EMPTY_FORM);
  ...
  const handleChange = useCallback((field: keyof BusinessProfileData, value: string | null) => {
