      ...
      >
        <Container variant="column" className="px-6 pt-8">
          <Animated.View
            ...
            className="items-center mb-8 bg-error-50/50 p-6 rounded-[32px] border border-error-100/50 w-full"
          >
            <AlertCircle size={40} color="#EF4444" className="mb-4" />
            <Typography
              variant="h3"
              className="text-center mb-2 text-error-900 font-bold"
            >
              Report an Issue
            </Typography>
            <Typography
              variant="body"
              className="text-center text-error-700/80"
            >
              Booking ID:{' '}
              <Typography className="font-heading-bold">{bookingId}</Typography>
            </Typography>
            <Typography
              variant="body-sm"
              className="text-center mt-2 text-error-600/60"
            >
          ...
          <Container variant="row" gap={3} className="mt-8 w-full">
            <Button
              variant="outlined"
              onPress={onCancel}
              size="md"
