        ...
        <Container variant="column-centered" className="px-6 pt-10">
          ...
          >
            ...
            {rating > 0 && (
              <Typography
                variant="body"
                className="font-heading-semibold text-primary-500 mt-2"
              >
          ...
          <Container variant="column-start" gap={3} className="w-full mb-8">
            <Typography
              variant="body-sm"
              className="text-slate-900 font-heading-semibold uppercase tracking-wider"
            >
              WHAT DID YOU LIKE?
            </Typography>
              ...
              {FEEDBACK_TAGS.map(tag => (
                ...
                >
                  <Typography
                    ...
                    className={
                      selectedTags.includes(tag)
                        ? 'text-primary-600 font-body-medium'
                        : 'text-slate-600'
                    }
                  >
                    {tag}
          ...
          <Container variant="column-start" gap={3} className="w-full mb-10">
            ...
            <View className="flex-row gap-4">
              ...
              {MOCK_REVIEW_PHOTOS.map((uri, i) => (
                <PhotoPreview key={i} uri={uri} index={i} />
              ))}
            </View>
          </Container>
