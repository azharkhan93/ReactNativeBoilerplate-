...
export type Query = {
  ...
  getVendorBankDetails: BankDetailsType;
...
export type GetVendorBankDetailsQuery = { __typename?: 'Query', getVendorBankDetails: { __typename?: 'BankDetailsType', id: string, vendorProfileId: string, accountHolder: string, bankName: string, ifscCode: string, accountNumber: string } };
