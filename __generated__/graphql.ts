...
export type Booking = {
  ...
  vendorProfile?: Maybe<VendorProfileType>;
};

/** Valid push notification triggers for a booking journey */
export enum BookingNotificationType {
  JourneyHalfway = 'JOURNEY_HALFWAY',
...
/** Categories of detected vehicle surface conditions */
...
/** Severity levels of vehicle surface flaws */
...
export type CreateVendorServiceInput = {
  availableAtCenter?: Scalars['Boolean']['input'];
  availableAtHome?: Scalars['Boolean']['input'];
  ...
  pricings?: InputMaybe<Array<ServicePricingInput>>;
...
export type DetectedConditionType = {
  __typename?: 'DetectedConditionType';
...
export type Mutation = {
  ...
  registerDeviceToken: UserDeviceTokenType;
  ...
  scanVehicleCondition: VehicleScanResultType;
  sendBookingNotification: Scalars['Boolean']['output'];
...
export type MutationScanVehicleConditionArgs = {
  base64Images: Array<Scalars['String']['input']>;
};


export type MutationSendBookingNotificationArgs = {
  bookingId: Scalars['ID']['input'];
...
export type MutationVerifyPaymentSuccessArgs = {
...
export type Query = {
  ...
  disputeByBookingId?: Maybe<Dispute>;
  ...
  getUserNotifications: Array<NotificationType>;
  ...
  reviewByBookingId?: Maybe<Review>;
  roleById: Role;
  roles: Array<Role>;
  searchVendors: Array<VendorProfileType>;
  serviceCategories: Array<ServiceCategory>;
  user: UserType;
  users: Array<UserType>;
  vendorBookings: Array<Booking>;
  vendorReviews: Array<Review>;
};
...
export type QueryDisputeByBookingIdArgs = {
  bookingId: Scalars['ID']['input'];
};
...
export type QueryReviewByBookingIdArgs = {
  bookingId: Scalars['ID']['input'];
};
...
export type QueryVendorBookingsArgs = {
  status?: InputMaybe<BookingStatus>;
  vendorProfileId: Scalars['ID']['input'];
};


export type QueryVendorReviewsArgs = {
  vendorProfileId: Scalars['ID']['input'];
};

export type RecommendedPackageType = {
  __typename?: 'RecommendedPackageType';
  discountedPrice?: Maybe<Scalars['Float']['output']>;
  originalPrice?: Maybe<Scalars['Float']['output']>;
  packageId: Scalars['String']['output'];
  reason: Scalars['String']['output'];
  suggestedAddons: Array<Scalars['String']['output']>;
  title: Scalars['String']['output'];
};
...
export type UpdateVendorServiceInput = {
  availableAtCenter?: InputMaybe<Scalars['Boolean']['input']>;
  availableAtHome?: InputMaybe<Scalars['Boolean']['input']>;
  categoryId?: InputMaybe<Scalars['ID']['input']>;
  description?: InputMaybe<Scalars['String']['input']>;
...
export type UserDeviceTokenType = {
  __typename?: 'UserDeviceTokenType';
  createdAt: Scalars['DateTime']['output'];
...
export type VehicleScanResultType = {
  __typename?: 'VehicleScanResultType';
  detectedConditions: Array<DetectedConditionType>;
  estimatedColor?: Maybe<Scalars['String']['output']>;
  isVehicleDetected: Scalars['Boolean']['output'];
  overallConditionScore: Scalars['Int']['output'];
  recommendedPackage: RecommendedPackageType;
  retakeGuidance?: Maybe<Scalars['String']['output']>;
...
export type VendorService = {
  ...
  availableAtCenter: Scalars['Boolean']['output'];
  availableAtHome: Scalars['Boolean']['output'];
...
export type ScanVehicleConditionMutationVariables = Exact<{
  base64Images: Array<Scalars['String']['input']> | Scalars['String']['input'];
}>;


export type ScanVehicleConditionMutation = { __typename?: 'Mutation', scanVehicleCondition: { __typename?: 'VehicleScanResultType', isVehicleDetected: boolean, vehicleType?: string | null, estimatedColor?: string | null, overallConditionScore: number, retakeGuidance?: string | null, detectedConditions: Array<{ __typename?: 'DetectedConditionType', id: string, category: ConditionCategory, name: string, severity: ConditionSeverity, confidenceScore: number, summary: string }>, recommendedPackage: { __typename?: 'RecommendedPackageType', packageId: string, title: string, reason: string, originalPrice?: number | null, discountedPrice?: number | null, suggestedAddons: Array<string> } } };
...
export type GetCustomerBookingsQuery = { __typename?: 'Query', customerBookings: Array<{ __typename?: 'Booking', id: string, userId: string, serviceId: string, status: BookingStatus, scheduledAt: any, totalPrice?: number | null, createdAt: any, service?: { __typename?: 'VendorService', id: string, name: string, price: number } | null, vendorProfile?: { __typename?: 'VendorProfileType', id: string, businessName: string, imageUri?: string | null } | null }> };

export type GetVendorBookingsQueryVariables = Exact<{
  vendorProfileId: Scalars['ID']['input'];
  status?: InputMaybe<BookingStatus>;
}>;


export type GetVendorBookingsQuery = { __typename?: 'Query', vendorBookings: Array<{ __typename?: 'Booking', id: string, userId: string, serviceId: string, status: BookingStatus, scheduledAt: any, totalPrice?: number | null, createdAt: any, user?: { __typename?: 'UserType', id: string, name?: string | null, phoneNumber: string, avatarUrl?: string | null } | null, service?: { __typename?: 'VendorService', id: string, name: string, price: number } | null }> };
...
export type CreateBookingMutation = { __typename?: 'Mutation', createBooking: { __typename?: 'Booking', id: string, userId: string, serviceId: string, status: BookingStatus, scheduledAt: any, totalPrice?: number | null } };
...
export type CreateReviewMutation = { __typename?: 'Mutation', createReview: { __typename?: 'Review', id: string, bookingId: string, rating: number, comment?: string | null, createdAt: any } };
...
export type CreateDisputeMutation = { __typename?: 'Mutation', createDispute: { __typename?: 'Dispute', id: string, bookingId: string, reason: string, status: string, createdAt: any } };
...
export type GetUserAvatarQuery = { __typename?: 'Query', user: { __typename?: 'UserType', id: string, avatarUrl?: string | null } };

export type DeleteCustomerProfileMutationVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type DeleteCustomerProfileMutation = { __typename?: 'Mutation', deleteCustomerProfile: boolean };
...
export type UpdateUserAvatarMutation = { __typename?: 'Mutation', updateUserAvatar: { __typename?: 'UserType', id: string, avatarUrl?: string | null } };
...
export type CreatePaymentMutation = { __typename?: 'Mutation', createPayment: { __typename?: 'Payment', id: string, customerProfileId: string, razorpayOrderId: string, amount: number, currency: string, status: PaymentStatus } };

export type VerifyPaymentSuccessMutationVariables = Exact<{
  input: VerifyPaymentInput;
}>;


export type VerifyPaymentSuccessMutation = { __typename?: 'Mutation', verifyPaymentSuccess: { __typename?: 'Payment', id: string, status: PaymentStatus, razorpayOrderId: string, razorpayPaymentId?: string | null, razorpaySignature?: string | null } };
...
export type GetPaymentByOrderIdQuery = { __typename?: 'Query', getPaymentByOrderId?: { __typename?: 'Payment', id: string, status: PaymentStatus, amount: number, currency: string } | null };
...
export type VendorProfileFieldsFragment = { __typename?: 'VendorProfileType', id: string, userId: string, businessName: string, imageUri?: string | null, gstNumber?: string | null, contactNumber?: string | null, address?: string | null, serviceRadius?: string | null, operatingHours?: string | null, whyChooseMe?: string | null, description?: string | null, images: Array<string>, categories: Array<{ __typename?: 'ServiceCategory', id: string, name: string, icon: string }> } & { ' $fragmentName'?: 'VendorProfileFieldsFragment' };
...
export type GetVendorServicesQuery = { __typename?: 'Query', getVendorServices: Array<{ __typename?: 'VendorService', id: string, vendorProfileId: string, name: string, description?: string | null, price: number, duration: number, location?: string | null, features: Array<string>, images: Array<string>, categoryId?: string | null }> };
...
export type CreateVendorServiceMutation = { __typename?: 'Mutation', createVendorService: { __typename?: 'VendorService', id: string, vendorProfileId: string, name: string, description?: string | null, price: number, duration: number, location?: string | null, features: Array<string>, images: Array<string>, categoryId?: string | null } };
...
export type UpdateVendorServiceMutation = { __typename?: 'Mutation', updateVendorService: { __typename?: 'VendorService', id: string, vendorProfileId: string, name: string, description?: string | null, price: number, duration: number, location?: string | null, features: Array<string>, images: Array<string>, categoryId?: string | null } };
...
export type UpdateDriverLocationMutation = { __typename?: 'Mutation', updateDriverLocation: { __typename?: 'DriverLocationType', bookingId: string, latitude: number, longitude: number, status: string, eta: number } };
...
export type RegisterDeviceTokenMutation = { __typename?: 'Mutation', registerDeviceToken: { __typename?: 'UserDeviceTokenType', id: string, fcmToken: string } };
...
export type SearchVendorsQuery = { __typename?: 'Query', searchVendors: Array<{ __typename?: 'VendorProfileType', id: string, businessName: string, description?: string | null }> };

export type GetBookingDetailsTrackingQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type GetBookingDetailsTrackingQuery = { __typename?: 'Query', bookingById: { __typename?: 'Booking', id: string, status: BookingStatus, service?: { __typename?: 'VendorService', id: string, name: string } | null, vendorProfile?: { __typename?: 'VendorProfileType', id: string, businessName: string } | null } };
...
export type SendBookingNotificationMutationVariables = Exact<{
  bookingId: Scalars['ID']['input'];
  type: BookingNotificationType;
}>;


export type SendBookingNotificationMutation = { __typename?: 'Mutation', sendBookingNotification: boolean };
...
export const ScanVehicleConditionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ScanVehicleCondition"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"base64Images"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"scanVehicleCondition"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"base64Images"},"value":{"kind":"Variable","name":{"kind":"Name","value":"base64Images"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"isVehicleDetected"}},{"kind":"Field","name":{"kind":"Name","value":"vehicleType"}},{"kind":"Field","name":{"kind":"Name","value":"estimatedColor"}},{"kind":"Field","name":{"kind":"Name","value":"overallConditionScore"}},{"kind":"Field","name":{"kind":"Name","value":"retakeGuidance"}},{"kind":"Field","name":{"kind":"Name","value":"detectedConditions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"severity"}},{"kind":"Field","name":{"kind":"Name","value":"confidenceScore"}},{"kind":"Field","name":{"kind":"Name","value":"summary"}}]}},{"kind":"Field","name":{"kind":"Name","value":"recommendedPackage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"packageId"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"originalPrice"}},{"kind":"Field","name":{"kind":"Name","value":"discountedPrice"}},{"kind":"Field","name":{"kind":"Name","value":"suggestedAddons"}}]}}]}}]}}]} as unknown as DocumentNode<ScanVehicleConditionMutation, ScanVehicleConditionMutationVariables>;
export const GetCustomerBookingsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetCustomerBookings"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"userId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"status"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"BookingStatus"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"customerBookings"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"userId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"userId"}}},{"kind":"Argument","name":{"kind":"Name","value":"status"},"value":{"kind":"Variable","name":{"kind":"Name","value":"status"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}},{"kind":"Field","name":{"kind":"Name","value":"serviceId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"scheduledAt"}},{"kind":"Field","name":{"kind":"Name","value":"totalPrice"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"service"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"price"}}]}},{"kind":"Field","name":{"kind":"Name","value":"vendorProfile"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"businessName"}},{"kind":"Field","name":{"kind":"Name","value":"imageUri"}}]}}]}}]}}]} as unknown as DocumentNode<GetCustomerBookingsQuery, GetCustomerBookingsQueryVariables>;
export const GetVendorBookingsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetVendorBookings"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"vendorProfileId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"status"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"BookingStatus"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"vendorBookings"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"vendorProfileId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"vendorProfileId"}}},{"kind":"Argument","name":{"kind":"Name","value":"status"},"value":{"kind":"Variable","name":{"kind":"Name","value":"status"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}},{"kind":"Field","name":{"kind":"Name","value":"serviceId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"scheduledAt"}},{"kind":"Field","name":{"kind":"Name","value":"totalPrice"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"phoneNumber"}},{"kind":"Field","name":{"kind":"Name","value":"avatarUrl"}}]}},{"kind":"Field","name":{"kind":"Name","value":"service"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"price"}}]}}]}}]}}]} as unknown as DocumentNode<GetVendorBookingsQuery, GetVendorBookingsQueryVariables>;
...
export const UpdateBookingStatusDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateBookingStatus"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"status"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BookingStatus"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateBookingStatus"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"status"},"value":{"kind":"Variable","name":{"kind":"Name","value":"status"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]} as unknown as DocumentNode<UpdateBookingStatusMutation, UpdateBookingStatusMutationVariables>;
...
export const GetUserAvatarDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetUserAvatar"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"avatarUrl"}}]}}]}}]} as unknown as DocumentNode<GetUserAvatarQuery, GetUserAvatarQueryVariables>;
export const DeleteCustomerProfileDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteCustomerProfile"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteCustomerProfile"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<DeleteCustomerProfileMutation, DeleteCustomerProfileMutationVariables>;
export const UpdateUserAvatarDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateUserAvatar"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"avatarUrl"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateUserAvatar"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"avatarUrl"},"value":{"kind":"Variable","name":{"kind":"Name","value":"avatarUrl"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"avatarUrl"}}]}}]}}]} as unknown as DocumentNode<UpdateUserAvatarMutation, UpdateUserAvatarMutationVariables>;
...
export const VerifyPaymentSuccessDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"VerifyPaymentSuccess"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"VerifyPaymentInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"verifyPaymentSuccess"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"razorpayOrderId"}},{"kind":"Field","name":{"kind":"Name","value":"razorpayPaymentId"}},{"kind":"Field","name":{"kind":"Name","value":"razorpaySignature"}}]}}]}}]} as unknown as DocumentNode<VerifyPaymentSuccessMutation, VerifyPaymentSuccessMutationVariables>;
export const GetPaymentByOrderIdDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetPaymentByOrderId"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"orderId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getPaymentByOrderId"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"orderId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"orderId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"amount"}},{"kind":"Field","name":{"kind":"Name","value":"currency"}}]}}]}}]} as unknown as DocumentNode<GetPaymentByOrderIdQuery, GetPaymentByOrderIdQueryVariables>;
...
export const DeleteVendorBankDetailsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteVendorBankDetails"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"vendorProfileId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteVendorBankDetails"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"vendorProfileId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"vendorProfileId"}}}]}]}}]} as unknown as DocumentNode<DeleteVendorBankDetailsMutation, DeleteVendorBankDetailsMutationVariables>;
...
export const UpdateDriverLocationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateDriverLocation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"bookingId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"latitude"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Float"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"longitude"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Float"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"status"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"eta"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateDriverLocation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"bookingId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"bookingId"}}},{"kind":"Argument","name":{"kind":"Name","value":"latitude"},"value":{"kind":"Variable","name":{"kind":"Name","value":"latitude"}}},{"kind":"Argument","name":{"kind":"Name","value":"longitude"},"value":{"kind":"Variable","name":{"kind":"Name","value":"longitude"}}},{"kind":"Argument","name":{"kind":"Name","value":"status"},"value":{"kind":"Variable","name":{"kind":"Name","value":"status"}}},{"kind":"Argument","name":{"kind":"Name","value":"eta"},"value":{"kind":"Variable","name":{"kind":"Name","value":"eta"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bookingId"}},{"kind":"Field","name":{"kind":"Name","value":"latitude"}},{"kind":"Field","name":{"kind":"Name","value":"longitude"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"eta"}}]}}]}}]} as unknown as DocumentNode<UpdateDriverLocationMutation, UpdateDriverLocationMutationVariables>;
...
export const SendBookingNotificationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SendBookingNotification"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"bookingId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"type"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BookingNotificationType"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"sendBookingNotification"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"bookingId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"bookingId"}}},{"kind":"Argument","name":{"kind":"Name","value":"type"},"value":{"kind":"Variable","name":{"kind":"Name","value":"type"}}}]}]}}]} as unknown as DocumentNode<SendBookingNotificationMutation, SendBookingNotificationMutationVariables>;