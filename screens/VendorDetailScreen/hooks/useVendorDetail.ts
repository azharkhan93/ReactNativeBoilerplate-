...
const TEST_FALLBACK_VENDORS = [
  {
    ...
    gstNumber: 'GST12345',
    contactNumber: '+91 6005578909',
    address: '742 Evergreen Terrace, Springfield',
    serviceRadius: '5km',
    operatingHours: 'Mon - Sat, 09:00 AM - 08:00 PM',
    whyChooseMe:
      'Eco-friendly steam wash, premium microfiber towels, scratch-free detailing guarantees.',
    description:
      'Serving the community for over 10 years, Sparkle Car Wash offers high-end detailing and exterior cleaning solutions for Sedans, SUVs, and luxury sports vehicles.',
    images: [
  ...
  },
  {
    ...
    whyChooseMe:
      'Certified detailing experts, ceramic coating specialists, premium interior shampoo treatments.',
    description:
      'Elite Auto Spa is your ultimate destination for comprehensive car restoration and paint protection. We use state-of-the-art tools and luxury waxes.',
    images: [
